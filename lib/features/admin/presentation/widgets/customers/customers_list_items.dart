...
class CustomersListItems extends StatelessWidget {
  User user;

  CustomersListItems({super.key, required this.user});
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            gradient: LinearGradient(
                ...
                colors: [
                  HSVColor.fromColor(AppPallete.color4).withValue(0.8).toColor(),
                  HSVColor.fromColor(AppPallete.color4).withValue(0.8).toColor(),
                  AppPallete.color4,
                  AppPallete.color4
                ],
